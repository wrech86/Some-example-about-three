import '../../style/camera/logarithmicdepthbuffer.css'
...
// let screenLeft = 0.25,screenRight
// const mouse = [ .5, .5 ];
...
//   loader.load('/node_modules/three/examples/fonts/helvetiker_regular.typeface.json',(data)=>{
//     let scene = createScene(data)
//     objects.leftScreen = createView(scene,'left',false)
//     objects.rightScreen = createView(scene,'right',true)
//     time()
//     console.log(scene);
//   })
...
// }
// function createView(scene,string,log){
//   const flag = document.getElementById(string)
//   const camera = new THREE.PerspectiveCamera(50,screenLeft*width/height,NEAR,FAR)
//   scene.add(camera)
//   const renderer = new THREE.WebGLRenderer({
//     antialias:true,
//     //开启对数缓冲
//     logarithmicDepthBuffer:log
//   })
//   renderer.setPixelRatio(Math.min(window.devicePixelRatio||2))
//   //有两个渲染界面
//   renderer.setSize(width/2,height)
//   renderer.domElement.style.position = 'relative'
//   renderer.domElement.id = `renderer_${string}`
//   flag.appendChild(renderer.domElement)
//   return {flag,renderer,scene,camera}
// }
...
//   screenRight = 1-screenLeft
//   objects.leftScreen.renderer.setSize(width*screenLeft,height)
//   objects.leftScreen.camera.aspect=width*screenLeft/height
//   objects.leftScreen.camera.updateProjectionMatrix()
//   objects.leftScreen.camera.setViewOffset(width,height,0,0,width+screenLeft,height)
//   objects.leftScreen.flag.style.width=`${screenLeft*100}%`

//   objects.rightScreen.renderer.setSize(width*screenRight,height)
//   objects.rightScreen.camera.aspect=width*screenRight/height
//   objects.rightScreen.camera.updateProjectionMatrix()
//   objects.rightScreen.camera.setViewOffset(width,height,width*screenLeft,0,width*screenRight,height)
//   objects.rightScreen.flag.style.width=`${screenRight*100}%`

//   border.style.left = `${screenLeft*100}%`
// }
// function time(){
...
//   const maxzoom = labeldata[labeldata.length-1].size * labeldata[labeldata.length-1] * 100
...
//   zoompos += zoomspeed
//   zoomspeed *= damping
//   objects.leftScreen.camera.position.x = Math.sin( .5 * Math.PI * ( mouse[ 0 ] - .5 ) ) * zoom;
//   objects.leftScreen.camera.position.y = Math.sin( .25 * Math.PI * ( mouse[ 1 ] - .5 ) ) * zoom;
// 	objects.leftScreen.camera.position.z = Math.cos( .5 * Math.PI * ( mouse[ 0 ] - .5 ) ) * zoom;
// 	objects.leftScreen.camera.lookAt( objects.leftScreen.scene.position );

//   objects.rightScreen.camera.position.copy( objects.leftScreen.camera.position)
//   objects.rightScreen.camera.quaternion.copy( objects.leftScreen.camera.quaternion)
//   if ( screenRight != 1 - screenLeft ) {

//     updateRendererSizes();

//   }
//   objects.leftScreen.renderer.render(objects.leftScreen.scene,objects.leftScreen.camera)
//   objects.rightScreen.renderer.render(objects.rightScreen.scene,objects.rightScreen.camera)
// }
...
//   screenLeft = Math.max( 0, Math.min( 1, ev.clientX / window.innerWidth ) );
